...
from .views import AdminGrades, AdminSubjects, AdminTeachers, AdminStudents, AdminAdmissionAttorney,\
    AdminAdmissionStudentSet, AdminAdmissionAttorneySet, AdminAdmissionStudent, AdminAdmissionenRollment

urlpatterns = [
    url(r'^grades', AdminGrades.as_view(), name='grades'),
    url(r'^subjects', AdminSubjects.as_view(), name='subjects'),
    url(r'^tachers', AdminTeachers.as_view(), name='teachers'),
    ...
    url(r'^enrollment/(?P<rut>[a-z0-9,-]+)/(?P<student>[a-z0-9,-]+)/$', AdminAdmissionenRollment.as_view(), name='admission_enrollment_set'),
]
